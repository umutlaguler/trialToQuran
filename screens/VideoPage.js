...
otherVideo = (count) => {
  ...
  this.setState({videoId:this.videoIds[count]})
  console.log("ne oldu ", this.state.videoId);
}
...
render(){
    ...
    return(
      ...
      <Text style={styles.welcome}>{'youtube denemesi'}</Text>
      ...
      <View style={styles.buttonGroup}>
        <Button
          title="diğer video"
          onPress={() => {
              this.otherVideo(this.state.countState)
          }}
        />
        {/* <Button
